import{c as u,u as j,h as b,b as y,r as v,j as e,m as p,k as _,B as m,X as N,g as w}from"./index-q20FlQln-1785752597218.js";import{u as C}from"./useAppDate-DnoKyAnW-1785752597218.js";import{D as z,a as S}from"./dialog-BGgxLEgY-1785752597218.js";import{C as k}from"./smartphone-CxrhRlbv-1785752597218.js";import{P as T}from"./printer-i39cJ-gy-1785752597218.js";const M=u("Banknote",[["rect",{width:"20",height:"12",x:"2",y:"6",rx:"2",key:"9lu3g6"}],["circle",{cx:"12",cy:"12",r:"2",key:"1c9p78"}],["path",{d:"M6 12h.01M18 12h.01",key:"113zkx"}]]),B={cash:"Espèces",mvola:"MVola",orange_money:"Orange Money",airtel_money:"Airtel Money"};function F({open:a,onClose:l,transaction:s}){const{formatCurrency:n}=j(),{enableTables:r}=b(),{data:x}=y({queryKey:["settings"],queryFn:()=>w.entities.Settings.get()}),{formatDate:d}=C(),i=x||{},h=()=>{const t=window.open("","","width=400,height=600");let o=document.getElementById("receipt-content").innerHTML;const f=window.location.origin;o=o.replace(/src="\/uploads\//g,`src="${f}/uploads/`),t.document.write(`
      <html>
        <head>
